...
class Ethernet : public Stackable
{
  ...
  public:
    /// @brief 宛先MACアドレス
    Utility::ObservableProperty<uint8_t *> DestinationMac; // TODO メモリ直利用を避ける

    /// @brief 送信元MACアドレス
    Utility::ObservableProperty<uint8_t *> SourceMac; // TODO メモリ直利用を避ける

    /// @brief イーサネットタイプ
    Utility::ObservableProperty<uint16_t> EthernetType;
